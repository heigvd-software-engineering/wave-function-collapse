...
const prototypes = [
  ...
  new Prototype(
    ...
    TILE_ROTATION.R_None,
    {
      posX: SOCKET_TYPE.H_6_S,
      negX: SOCKET_TYPE.H_6_S,
      posY: SOCKET_TYPE.V_3_0,
      negY: SOCKET_TYPE.V_3_0_B,
      posZ: SOCKET_TYPE.H_6_S,
      negZ: SOCKET_TYPE.H_6_S,
    },
    1,
  ),
  new Prototype(
  ...
  new Prototype(
    TILE_TYPE.WA1, // TODO : angle can have both inside and outside tiles
    TILE_ROTATION.R0,
    {
      posX: SOCKET_TYPE.H_1_S,
      negX: SOCKET_TYPE.H_0_S,
